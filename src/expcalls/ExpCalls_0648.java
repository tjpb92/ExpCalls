...
public class ExpCalls_0648 extends AbstractExpCalls {
     ...
     */
    public ExpCalls_0648(ExpCallsParams MyExpcallsParams) throws IOException, DBServerException, SQLException {
...
//            MyXMLDocument.FinalizeXMLDocument(MyArgs.getFileOut());
    ...
    public void processTickets(ExpCallsParams MyExpcallsParams,
            Calls_0648_XMLDocument MyXMLDocument, EtatTicket MyEtatTicket) {

        Fcalls MyFcalls;
        FcallsDAO MyFcallsDAO;
        int i;
        Ticket_0648 MyTicket_0648;
        ...
        try {
            ...
            while ((MyFcalls = MyFcallsDAO.select()) != null) {
                i++;
                MyTicket_0648 = new Ticket_0648(MyConnection, MyFcalls, MyEtatTicket);
                System.out.println("Ticket(" + i + ")=" + MyTicket_0648);
                MyXMLDocument.AddToXMLDocument(MyTicket_0648);
            }
