...
public class ExpCalls_0609 extends AbstractExpCalls {
     ...
     */
    public ExpCalls_0609(ExpCallsParams MyExpcallsParams) throws IOException, DBServerException, SQLException {
...
//            MyXMLDocument.FinalizeXMLDocument(MyArgs.getFileOut());
    ...
    public void processTickets(ExpCallsParams MyExpcallsParams,
            Calls_0609_XMLDocument MyXMLDocument, EtatTicket MyEtatTicket) {

        Fcalls MyFcalls;
        FcallsDAO MyFcallsDAO;
        int i;
        Ticket_0609 MyTicket_0609;
        ...
        try {
            ...
            while ((MyFcalls = MyFcallsDAO.select()) != null) {
                i++;
                MyTicket_0609 = new Ticket_0609(MyConnection, MyFcalls, MyEtatTicket);
                System.out.println("Ticket(" + i + ")=" + MyTicket_0609);
                MyXMLDocument.AddToXMLDocument(MyTicket_0609);
            }
