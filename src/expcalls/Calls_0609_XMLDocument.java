...
public class Calls_0609_XMLDocument extends XMLDocument {
     ...
     */
    public void AddToXMLDocument(Ticket_0609 MyTicket) {
        ...
        MyElement = MyDocument.createElement("ZoneGeographique");
        Ticket.appendChild(MyElement);
        if (MyTicket.Fcalls_0000.getCseqno() == 620) 
        ...
        // Numéro du site
        MyElement = MyDocument.createElement("NumeroSite");
        Ticket.appendChild(MyElement);
        ...
        Ticket.appendChild(MyElement);
        MyString = MyTicket.getSiteSousContrat();
        if (MyString != null) {
            MyElement.appendChild(MyDocument.createTextNode(MyString));
        }
    }
