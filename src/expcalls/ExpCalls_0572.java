 ...
 * client 572 dans un fichier au format XML.
 *
...
public class ExpCalls_0572 extends AbstractExpCalls {
     ...
     */
    public ExpCalls_0572(ExpCallsParams expCallsParams) throws IOException, DBServerException, SQLException {
...
//            MyXMLDocument.FinalizeXMLDocument(MyArgs.getFileOut());
    ...
    public void processTickets(ExpCallsParams expCallsParams,
            Calls_0572_XMLDocument MyXMLDocument, EtatTicket etatTicket) {

        Fcalls fcalls;
        FcallsDAO fcallsDAO;
        int i;
        Ticket_0572 ticket_0572;
        ...
        try {
            ...
            while ((fcalls = fcallsDAO.select()) != null) {
                i++;
                ticket_0572 = new Ticket_0572(connection, fcalls, etatTicket);
                System.out.println("Ticket(" + i + ")=" + ticket_0572);
                MyXMLDocument.AddToXMLDocument(ticket_0572);
            }
